...
shapefile_dir <- "data/data_toon/shapes_transboundary"
...
for (shapefile_path in shapefiles_toon) {
  ...
  rds_naam <- paste0("resultaten/raw_objects/protconn_raw_trans_", jaar, ".rds")
...
output_csv <- "resultaten/protconn_resultaten_2021_2024_trans.csv"
